...
<div>
    ...
    <div className="container py-5">
        ...
        <div className="col-lg-6">
            <h1 className="display-4">Unveiling Our Story</h1>
            <p className="lead text-muted mb-0">Nurturing a World of Informed Perspectives</p>
        </div>
    ...
    <div className="container py-5">
        ...
        <div className="col-lg-6 order-2 order-lg-1"><i className="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
            <h2 className="font-weight-light">Navigating Today's Tapestry: Your News Compass</h2>
            <p className="font-italic text-muted mb-4">Embark on a journey with us through the ever-changing landscape of current events. We unravel stories, offering insight and understanding amidst the chaos. Let us be your trusted guide in navigating the intricate threads of news.</p><a href="/" className="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
        </div>
        ...
        <div className="col-lg-6"><i className="fa fa-leaf fa-2x mb-3 text-primary"></i>
            <h2 className="font-weight-light">Our Editorial Ethos: Crafting Truthful Narratives</h2>
            <p className="font-italic text-muted mb-4">At the heart of our news website lies a steadfast dedication to journalistic integrity. We meticulously gather, verify, and present stories that reflect the essence of truth. Join us in our commitment to delivering narratives that stand the test of scrutiny and time.</p><a href="/" className="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
        </div>
        </div>
    </div>
    </div>
...
<div className="bg-light py-5">
  <div className="container py-5">
        ...
        <div className="col-lg-5">
            ...
            <p className="font-italic text-muted">Diverse minds, one passion – shaping news for the world.</p>
        </div>
        </div>
    ...
    <div className="row text-center">
      ...
      <div className="col-xl-3 col-sm-6 mb-5">
        <div className="bg-white rounded shadow-sm py-5 px-4"><img src="https://bootstrapious.com/i/snippets/sn-about/avatar-3.png" alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
          <h5 className="mb-0">Apurv Gore</h5><span className="small text-uppercase text-muted">CEO - Founder</span>
          <ul className="social mb-0 list-inline mt-3">
            <li className="list-inline-item"><a href="/" className="social-link"><i className="fa fa-facebook-f"></i></a></li>
            <li className="list-inline-item"><a href="/" className="social-link"><i className="fa fa-twitter"></i></a></li>
            <li className="list-inline-item"><a href="/" className="social-link"><i className="fa fa-instagram"></i></a></li>
